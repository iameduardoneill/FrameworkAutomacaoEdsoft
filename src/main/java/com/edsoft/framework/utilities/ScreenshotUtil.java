...
public class ScreenshotUtil {
	...
	File pdfRoot = new File(System.getProperty("user.dir") + "/screenshot-reporting/");
	...
	public ScreenshotUtil screenShot() throws IOException, DocumentException {
		String fonte = ".png";
		while (i >j) {
			File file = ((TakesScreenshot) DriverContext.Driver).getScreenshotAs(OutputType.FILE);
			String path = System.getProperty("user.dir") + "/screenshot-reporting/" + j + ".png";
			files.add(+j+""+ fonte);
